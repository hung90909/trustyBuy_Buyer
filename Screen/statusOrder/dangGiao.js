...
export default function DangGiao() {
  ...
  const getAllOrderForUser = () => {
    fetch(
      'https://7324-116-96-44-199.ngrok-free.app/v1/api/checkout/getAllOrderForUser/shipped',
      {
        headers: {
  ...
  const onReceived = id => {
    fetch(
      'https://7324-116-96-44-199.ngrok-free.app/v1/api/checkout/changeStatusByUser',
      {
        method: 'PATCH',
        headers: {
          'x-xclient-id': '654c8a081f10540692bdc998',
