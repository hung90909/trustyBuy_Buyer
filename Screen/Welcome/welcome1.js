...
const Welcome1 = () => {
    const data = [
        {
            image: "https://th.bing.com/th/id/OIP.mIJ22yp-GYpTdZSONq_bLgHaLH?pid=ImgDet&w=204&h=306&c=7&dpr=1.7",
            text: "Chúng tôi cung cấp các sản phẩm chất lượng cho bạn"
        },
        {
            image: "https://th.bing.com/th/id/OIP.i2enHpvw3tkVL9sCrg2gCwHaJA?pid=ImgDet&w=183&h=222&c=7&dpr=1.7",
            text: "Chúng tôi cung cấp các sản phẩm chất lượng cho bạn"
        },
        {
            image: "https://th.bing.com/th/id/OIP.mJw6N4vR4tmf0iTZNIzdtwAAAA?pid=ImgDet&w=183&h=240&c=7&dpr=1.7",
            text: "Chúng tôi cung cấp các sản phẩm chất lượng cho bạn"
        },
    ]
        ...
        <View style={styles.container}>
            <View style={{
                ...
                <Swiper 
                 ...
                 loop={false}  ref={swiperRef} onIndexChanged={onIndexChanged}
                 dot={
                    <View
                      style={{
