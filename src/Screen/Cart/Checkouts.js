...
import { ADD_CART_API, API_BASE_URL, CHECKOUT_API, DISCOUNT_API, GET_ADDRESS_API, ORDERS_API, PRODUCT_API } from '../../config/urls';
    ...
    return (
        <View style={styles.container}>
            <ScrollView >
                ...
                <TouchableOpacity
                    onPress={() => {
                        nav.navigate("ListAddress", { itemProduct: item, itemDiscount: itemDiscount })
                    }}
                    style={{
                    ...
                    <View>
                        ...
                        <View style={{ marginLeft: 30, width: "80%" }}>
                            <Text>{itemAddress ? itemAddress.customAddress : address.customAddress}</Text>
                        </View>
                    </View>
                        ...
                        renderItem={({ item }) => {
                            return (
                                <View style={{
                                    ...
                                    padding: 10, borderWidth: 0.5, borderRadius: 10
                                }}>
                                    ...
                                    <View style={{ flexDirection: "row", marginTop: 10 }}>
                                        ...
                                        <View style={{ marginStart: 10 }}>
                                            <Text style={{ fontSize: 15, color: "black", width: "70%" }} numberOfLines={1}>{item.name}</Text>
                                            <View style={{
                                                flexDirection: "row",
                                    ...
                                    <View style={{
                                        ...
                                        <Text style={{ fontWeight: "bold", color: "black" }}>Tổng số tiền: </Text>
                ...
                <View style={{
                    ...
                    <TouchableOpacity
                        onPress={() => {
                            nav.navigate("ListDiscount", { itemProduct: item, itemAddress: itemAddress })
                        }}
                        style={{
                            flexDirection: "row",
                            justifyContent: "space-between", alignItems: "center"
                        }}>
                        <Text style={{ fontSize: 16, color: "black" }}>Voucher khuyến mãi</Text>
                        <View style={{ flexDirection: "row", alignItems: "center" }}>
                            {itemDiscount ? <Text>Giảm {itemDiscount.discount_value}%</Text> : <Text style={{}}>Chọn hoặc nhập mã </Text>}
                            <Ionicons name='chevron-forward-outline' size={25} />
                        </View>
                    </TouchableOpacity>
                    <TouchableOpacity style={{
                        ...
                        <Text style={{ fontSize: 16, color: "black" }}>Phương thức thanh toán</Text>
                        <View style={{ flexDirection: "row", alignItems: "center" }}>
                            <Text numberOfLines={1} style={{ width: "60%", }}>Thanh toán khi nhận hàng </Text>
                            <Ionicons name='chevron-forward-outline' size={25} />
                        </View>
                    </TouchableOpacity>
                </View>
                <View style={{ paddingHorizontal: 15, marginTop: 20, marginBottom: 10 }}>
                    ...
                    <View style={{ flexDirection: "row", marginTop: 10, justifyContent: "space-between" }}>
                        ...
                        {itemDiscount ? <Text style={{ fontSize: 16 }}>{totalDisCount()}</Text> : <Text style={{ fontSize: 16 }}>0</Text>}
                    </View>
                    <View style={{ flexDirection: "row", marginTop: 10, justifyContent: "space-between" }}>
                        <Text style={{ fontSize: 16 }}>Tổng tiền hàng: </Text>
                        <Text style={{ fontSize: 16, color: "black", fontWeight: "bold" }}>{totalPriceBill()}</Text>
                    </View>
                </View>
